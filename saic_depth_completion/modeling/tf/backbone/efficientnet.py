...
class EfficientNet(tf.keras.layers.Layer):
    ...
    def __init__(self,
        ...
        if out_embeddings_list is not None:
            x = embeddings_list
        # Create model.
    ...
    def set_torch_weights(self, torch_weights):
        ...
        self.model.set_weights(tf_weights)


@registry.TF_BACKBONES.register("efficientnet-b0")
...
def EfficientNetB0(
    ...
    return EfficientNet(
        ...
        pooling=pooling, classes=classes, out_embeddings_list=out_embeddings_list,
        **kwargs
    )


@registry.TF_BACKBONES.register("efficientnet-b1")
@inject_tfkeras_modules
def EfficientNetB1(
        include_top=False,
        weights=None,
...
@registry.TF_BACKBONES.register("efficientnet-b2")
@inject_tfkeras_modules
...
@registry.TF_BACKBONES.register("efficientnet-b3")
@inject_tfkeras_modules
...
@registry.TF_BACKBONES.register("efficientnet-b4")
@inject_tfkeras_modules
def EfficientNetB4(
        include_top=False,
        weights=None,
        ...
        pooling=None,
        classes=1000,
        out_embeddings_list=(6, 10, 22, 32),
        **kwargs
):
    return EfficientNet(
        1.4, 1.8, 380, 0.4,
...
@registry.TF_BACKBONES.register("efficientnet-b5")
@inject_tfkeras_modules
def EfficientNetB5(
        include_top=False,
        weights=None,
        ...
        pooling=None,
        classes=1000,
        out_embeddings_list=(8, 13, 27, 39),
        **kwargs
):
    return EfficientNet(
        1.6, 2.2, 456, 0.4,
...
@registry.TF_BACKBONES.register("efficientnet-b6")
@inject_tfkeras_modules
def EfficientNetB6(
        include_top=False,
        weights=None,
        ...
        pooling=None,
        classes=1000,
        out_embeddings_list=(9, 15, 31, 45),
        **kwargs
):
    return EfficientNet(
        1.8, 2.6, 528, 0.5,
...
@registry.TF_BACKBONES.register("efficientnet-b7")
@inject_tfkeras_modules
def EfficientNetB7(
        include_top=False,
        weights=None,
        ...
        pooling=None,
        classes=1000,
        out_embeddings_list=(11, 18, 38, 55),
        **kwargs
):
    return EfficientNet(
        2.0, 3.1, 600, 0.5,
